...
- agentic & human threads: since we all read best Science Fiction books, we can imagine that AI Agents are being personalized - and work alongside people and other AI Agents. This is alrady happening in threads sessions, various chat implementations and starting with new wave of alternative Version Control Systems (not git-based, such as DELTA DB https://zed.dev/deltadb , https://pierre.computer, LAKE FS https://github.com/treeverse/lakeFS, ORIGIN https://cursor.com/origin, LORE https://lore.org and other) - this layer of communication will become more and more common and more needed for clear transparancy - just like in case of human to human communication.
...
1 - FOMO - Fear Of Missing Out (https://en.wikipedia.org/wiki/Fear_of_missing_out)
